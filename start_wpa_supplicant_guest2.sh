...
sleep 1
sudo ip link set dev sta1 address 00:15:6d:84:3c:13
sleep 1
sudo ifconfig sta1 192.168.7.20 netmask 255.255.255.0
sleep 1
sudo service network-manager stop /dev/null
sleep 1
sudo ifconfig sta1 up
sleep 1
wpa_supplicant -Dnl80211 -ista1 -c/root/wpa_supplicant_guest.conf &
sleep 2
iperf -s &
